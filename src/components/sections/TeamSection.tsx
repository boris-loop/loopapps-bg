  ...
  return (
    <section className="section-shell scroll-mt-24" id="team" aria-labelledby="team-title">
      <div className="mb-7 flex items-end justify-between gap-7 max-[53.75rem]:block">
        <h2 className="mb-0 whitespace-nowrap font-serif text-[clamp(2.4rem,4vw,4.1rem)] font-[450] leading-[0.98] max-[53.75rem]:whitespace-normal" id="team-title">The people inside the loop.</h2>
      </div>
